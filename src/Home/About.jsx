...
const About = () => {
  return (
    <div id="about" className="hero max-w-7xl mx-auto my-5   ">
      <div className="hero-content  w-full flex flex-col lg:flex-row">
        <div className="max-w-2xl text-white">
          <h1 className="text-5xl font-bold mb-5 font-fn">About Me</h1>
          <hr className="border-green-600 " />
          <p className="py-6 text-xl text-start text-white font-fn ">
        ...
        <div className="grid grid-cols-2 md:grid-col-3 lg:grid-cols-3 gap-4 ">
          <div className="h-42 w-42 rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1">
            <div className="rounded-xl flex justify-center items-center bg-zinc-800 h-40 w-40 ">
              <SiJavascript
                size={100}
                className=" text-yellow-400 rounded-xl"
              />
            </div>
          </div>
          <div className="h-42 w-42 rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1">
          ...
          <div className="h-42 w-42 rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1 shadow-xl">
            <div className="bg-zinc-800 rounded-xl h-40 w-40 flex justify-center items-center ">
              <IoLogoFirebase size={100} className=" text-amber-400" />
            </div>
          </div>
        </div>
      </div>
